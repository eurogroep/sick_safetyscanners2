...
namespace sick {
SickSafetyscanners::SickSafetyscanners(const rclcpp::Logger &logger)
    : m_logger(logger) {}
...
rcl_interfaces::msg::SetParametersResult SickSafetyscanners::parametersCallback(
  ...
  for (const auto &param : parameters) {
    ...
    RCLCPP_INFO(m_logger, "Got parameter: '%s'", ss.str().c_str());
...
void SickSafetyscanners::setupCommunication(
  ...
  RCLCPP_INFO(m_logger, "Communication to Sensor set up");
...
void SickSafetyscanners::readTypeCodeSettings() {
  RCLCPP_INFO(m_logger, "Reading Type code settings");
...
void SickSafetyscanners::readPersistentConfig() {
  RCLCPP_INFO(m_logger, "Reading Persistent Configuration");
